...
MODEL_OPTIONS: ProviderModeOptions = {
    "openai": {
        "quick": [
            ("GPT-5.6 Luna - Latest gen, fastest and lowest cost", "gpt-5.6-luna"),
            ("GPT-5.6 Terra - Latest gen, high-volume workhorse", "gpt-5.6-terra"),
            ("GPT-5.4 Mini - Fast, strong coding and tool use", "gpt-5.4-mini"),
            ("GPT-5.4 Nano - Cheapest, high-volume tasks", "gpt-5.4-nano"),
            ("GPT-5.5 - Previous frontier, 1M context", "gpt-5.5"),
        ],
        "deep": [
            ("GPT-5.6 Sol - Latest flagship, hardest problems", "gpt-5.6-sol"),
            ("GPT-5.6 Terra - Latest gen, high-volume workhorse", "gpt-5.6-terra"),
            ("GPT-5.5 - Previous frontier, 1M context", "gpt-5.5"),
            ("GPT-5.4 - 1M context, cost-effective", "gpt-5.4"),
